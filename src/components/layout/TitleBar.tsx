...
export function TitleBar() {
  ...
  if (platform === 'darwin') {
    ...
    return <div data-testid="titlebar" className="native-window-material drag-region h-10 shrink-0 border-b" />;
  }
...
function WindowsTitleBar() {
  ...
  return (
    <div data-testid="titlebar" className="window-material drag-region relative z-20 flex h-10 shrink-0 items-center justify-end border-b">

      {/* Right: Window Controls */}
      <div className="no-drag flex h-full">
        <button
          onClick={handleMinimize}
          className="flex h-full w-11 items-center justify-center text-muted-foreground transition-colors hover:bg-accent/70 hover:text-foreground"
          title="Minimize"
        >
